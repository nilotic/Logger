...
public macro Logger(_ message: String, _ subsystem: String = "Kurly", _ category: String = "", _ type: OSLogType = .info) = #externalMacro(module: "LoggerMacros", type: "LoggerMacro")
